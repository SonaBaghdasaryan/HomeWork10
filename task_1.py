...
# from builtins import ValueError, staticmethod, super
#
# class Animals:
...
#
# class Fish(Animals):
#     def __init__(self, fresh_water, depth, *args, **kwargs):
...
#         if self.depth <= 3:
#             return f"Мелководное до {self.depth} метров"
#         elif 3 < self.depth < 20:
...
#
#
# fish_params = {"name": "Salmon", "tail": True, "fresh_water": True, "depth": 5}
